...
{
    ("home", typeof(BlankPage1)),
    ("apps", typeof(BlankPage2)),
    ("games", typeof(BlankPage3)),
    ("music", typeof(BlankPage4)),
};
            ...
            Microsoft.UI.Xaml.Media.Animation.NavigationTransitionInfo transitionInfo)
        {
            ...
            var preNavPageType = Frame1.CurrentSourcePageType;

            // Only navigate if the selected page isn't currently loaded.
            if (!(_page is null) && !Type.Equals(preNavPageType, _page))
            {
                Frame1.Navigate(_page, null, transitionInfo);
            }
        }
        ...
        private void DispatcherQueue_AcceleratorKeyActivated(DispatcherQueue sender, AcceleratorKeyEventArgs e)
        {
        ...
        {
            NavView.IsBackEnabled = Frame1.CanGoBack;

            if (Frame1.SourcePageType == typeof(SettingsPage))
            {
                // SettingsItem is not part of NavView.MenuItems, and doesn't have a Tag.
                NavView.SelectedItem = (NavigationViewItem)NavView.SettingsItem;
                NavView.Header = "Settings";
            }
            else if (Frame1.SourcePageType != null)
            {
